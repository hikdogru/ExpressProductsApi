...
//             const scrape = await seeds.scrape(p.detailUrl)
//             let element = await scrape.page.$(productDetailMainSelector);
...
//                     features: features
//                 });
//                 const productDetailInDatabase = await ProductDetail.findOne({ productId: p._id });
